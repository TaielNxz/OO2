...
public class DatabaseProxyTest {
	...
	public void testGetSearchResults() {
	    Exception exceptionPending = assertThrows(RuntimeException.class, () -> {
	        this.proxy.getSearchResults("select * from comics where id=1");
	    });
	    assertEquals("Acceso denegado, inicie sesión primero", exceptionPending.getMessage());
        ...
        Exception exceptionPending2 = assertThrows(RuntimeException.class, () -> {
	...
	public void testInsertNewRow() {
	    Exception exceptionPending = assertThrows(RuntimeException.class, () -> {
	        this.proxy.insertNewRow(Arrays.asList("Patoruzú", "La flor"));
	    });
	    assertEquals("Acceso denegado, inicie sesión primero", exceptionPending.getMessage());
